...
public interface IJobRepository
{
    ...
    Task<Job> GetByIdAsync(Guid id, Guid jobDefinitionId, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<Job>> GetByJobDefinitionIdAsync(Guid jobDefinitionId, CancellationToken cancellationToken = default);
